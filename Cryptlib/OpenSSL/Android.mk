...
LOCAL_CFLAGS := -Wall -DOPENSSL_SYSNAME_UWIN -DOPENSSL_SYS_UEFI -DL_ENDIAN -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DOPENSSL_NO_CAMELLIA -DOPENSSL_NO_SEED -DOPENSSL_NO_RC5 -DOPENSSL_NO_MDC2 -DOPENSSL_NO_SOCK -DOPENSSL_NO_CMS -DOPENSSL_NO_JPAKE -DOPENSSL_NO_CAPIENG -DOPENSSL_NO_ERR -DOPENSSL_NO_KRB5 -DOPENSSL_NO_DYNAMIC_ENGINE -DGETPID_IS_MEANINGLESS -DOPENSSL_NO_STDIO -DOPENSSL_NO_FP_API -DOPENSSL_NO_DGRAM -DOPENSSL_NO_SHA0 -DOPENSSL_NO_LHASH -DOPENSSL_NO_HW -DOPENSSL_NO_OCSP -DOPENSSL_NO_LOCKING -DOPENSSL_NO_DEPRECATED -DOPENSSL_SMALL_FOOTPRINT -DPEDANTIC
ifeq ($(TARGET_UEFI_ARCH),x86_64)
    LOCAL_CFLAGS += -DSIXTY_FOUR_BIT_LONG
else
    LOCAL_CFLAGS += -DTHIRTY_TWO_BIT
endif
LOCAL_C_INCLUDES := \
	$(LOCAL_PATH)/../Include \
	$(LOCAL_PATH)/crypto \
	$(LOCAL_PATH)/..
LOCAL_MODULE := libopenssl-efi
LOCAL_STATIC_LIBRARIES := libefi libgnuefi
